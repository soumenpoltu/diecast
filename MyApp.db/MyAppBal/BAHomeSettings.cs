...
namespace MyApp.db.MyAppBal
{
    public class BAHomeSettings : IDisposable
    {
        ...
        public DataTable GetBanner<T>(String pMode, T pKey, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                vCount = 0;
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_GET_DTLS_BANNER_SETTING", CommandType.StoredProcedure))
                {
                    dt = oDBC.GetDataTable(pAccYr, pCompany_key, para, ref pMsg);
                }
            }
        ...
        public Byte SaveChanges<T1, T2>(String pMode, EntityHomeSetting oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            ...
            try
            {
                ...
                para[vCount] = new SqlParameter("@ICON_IMG_1", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_1;
                para[vCount] = new SqlParameter("@ICON_IMG_2", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_2;
                para[vCount] = new SqlParameter("@ICON_IMG_3", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_3;
                para[vCount] = new SqlParameter("@ICON_IMG_4", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_4;
                para[vCount] = new SqlParameter("@ICON_IMG_5", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_5;

                para[vCount] = new SqlParameter("@ICON_LINK_1", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_LINK_1;
                para[vCount] = new SqlParameter("@ICON_LINK_2", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_LINK_2;
                para[vCount] = new SqlParameter("@ICON_LINK_3", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_LINK_3;
                para[vCount] = new SqlParameter("@ICON_LINK_4", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_LINK_4;
                para[vCount] = new SqlParameter("@ICON_LINK_5", SqlDbType.VarChar, 200);
                para[vCount++].Value = oEntity.ICON_IMG_LINK_5;
        ...
        public DataSet GetBanner(String pMode, String pSEARCH_TEXT, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                vCount = 0;
        ...
        public Byte SaveBannerChanges<T1,T2>(String pMode, EntityHomeSetting oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                para[vCount] = new SqlParameter("@DTLS_BANNER_SETTING_KEY", SqlDbType.Int);
                para[vCount++].Value = oEntity.BANNER_KEY;
                para[vCount] = new SqlParameter("@HEAD_PRODUCT_KEY", SqlDbType.Int);
                para[vCount++].Value = oEntity.PRODUCT_KEY;
                para[vCount] = new SqlParameter("@BANNER_SETTING_IMG", SqlDbType.VarChar, 200);
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_SAVE_DTLS_BANNER_SETTING", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
                    vRef = Convert.ToByte(oDBC.GetParameterValue("@RETURN_KEY", ref pMsg));
                }
        ...
        public Byte SaveDelete<T>(String pMode, T pValue, ref T pKey, ref String pMsg, Int32 pUser, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_DELETE_DTLS_BANNER_SETTING", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
                    vRef = Convert.ToByte(oDBC.GetParameterValue("@RETURN_KEY", ref pMsg));
