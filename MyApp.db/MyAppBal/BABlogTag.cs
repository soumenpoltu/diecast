...
{
    public class BABlogTag : IDisposable
    {
        Int16 vCount = 0;
        DataTable dt = null;
        ...
        public DataTable BindDdl(Int32 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_GET_MAST_TOUR", CommandType.StoredProcedure))
                {
        ...
        public DataTable BindLB(Int32 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            try
            {
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_GET_MAST_BLOG_TAG", CommandType.StoredProcedure))
                {
                    dt = oDBC.GetDataTable(pAccYr, pCompany_key, para, ref pMsg);
        ...
        public Byte SaveChanges<T1, T2>(String pMode, EntityBlogTag oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            ...
            try
            {
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_SAVE_MAST_BLOG_TAG", CommandType.StoredProcedure))
                {
        ...
        public byte Delete<T>(String pMode, T pValue, ref T pKey, ref String pMsg, Int32 pUser, String pAccYr, Int16? pCompany_key)
        {
            ...
            try
            {
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_DELETE_MAST_BLOG_TAG", CommandType.StoredProcedure))
                {
                    oDBC.ExecuteNonQuery(pAccYr, pCompany_key, para, ref pMsg);
