...
{
    public class BAAboutUs : IDisposable
    {
        Int16 vCount = 0;
        DataTable dt = null;
        DataSet ds = null;
        ...
        public byte SaveChanges<T1, T2>(String pMode, EntityAboutUs oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                para[vCount] = new SqlParameter("@ABOUT_US_DESC", SqlDbType.VarChar, 9000);
                para[vCount++].Value = oEntity.ABOUT_US_DESC;
                para[vCount] = new SqlParameter("@ABOUT_US_IMAGE", SqlDbType.VarChar, 500);
                para[vCount++].Value = oEntity.ABOUT_US_IMAGE;
                ...
                using (sqlhelper oDBC = new sqlhelper("SP_SAVE_ABOUT_US", CommandType.StoredProcedure))
                {
        ...
        public byte AboutSaveChanges<T1, T2>(String pMode, EntityAboutUs oEntity, T1 pValue, ref T2 pKey, ref String pMsg, String pAccYr, Int16? pCompany_key)
        {
            Byte vRef = 0;
            try
            {
                ...
                para[vCount] = new SqlParameter("@ABOUT_DESC", SqlDbType.VarChar);
                para[vCount++].Value = oEntity.ABOUT_US_DESC;
                para[vCount] = new SqlParameter("@LOGO_1", SqlDbType.VarChar, 500);
                para[vCount++].Value = oEntity.ICON_IMG_1;
                para[vCount] = new SqlParameter("@LOGO_2", SqlDbType.VarChar, 500);
                para[vCount++].Value = oEntity.ICON_IMG_2;
                para[vCount] = new SqlParameter("@LOGO_3", SqlDbType.VarChar, 500);
                para[vCount++].Value = oEntity.ICON_IMG_3;
